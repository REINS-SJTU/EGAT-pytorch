...
class WandbLogger(Logger):
    ...
    def __init__(self, name: Optional[str] = None, config: Optional[dict] = None, save_dir: Optional[str] = None,
    ...
    def experiment(self) -> Run:
        ...
        if self._experiment is None:
            ...
            self._experiment = wandb.init(
                ...
                reinit=True, id=self._id, resume='allow', tags=self._tags, entity=self._entity, config=self._config)
